...
} from '@media-content/shared-types';
...
export class TmdbService {
    ...
    discoverMovies(params: DiscoverMoviesParams = {}): Observable<{
        ...
        if (params.withGenre != null)
            httpParams = httpParams.set('with_genres', params.withGenre);
        ...
        if (params['vote_average.gte'] != null)
            httpParams = httpParams.set(
                'vote_average.gte',
        ...
        return this.http
            .get<
                TmdbPaginatedResponse<TmdbMovieResult>
            >(`${this.baseUrl}/discover/movie`, { params: httpParams })
            .pipe(
                map((res) => ({
                    page: res.page,
